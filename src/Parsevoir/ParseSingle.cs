...
public static partial class Parse
{
    ...
    public static Tuple<T0, T1, T2> Single<T0, T1, T2>(string source, string template, int bracketsCount = 1,
        ParsingOptions? options = null)
        where T0 : IConvertible
        where T1 : IConvertible
    ...
    public static Tuple<T0, T1, T2, T3> Single<T0, T1, T2, T3>(string source, string template, int bracketsCount = 1,
        ParsingOptions? options = null)
        where T0 : IConvertible
        where T1 : IConvertible
        where T2 : IConvertible
    ...
    public static Tuple<T0, T1, T2, T3, T4> Single<T0, T1, T2, T3, T4>(string source, string template, int bracketsCount = 1,
        ParsingOptions? options = null)
        where T0 : IConvertible
        where T1 : IConvertible
        where T2 : IConvertible
    ...
    public static Tuple<T0, T1, T2, T3, T4, T5> Single<T0, T1, T2, T3, T4, T5>(string source, string template,
    ...
    public static Tuple<T0, T1, T2, T3, T4, T5, T6> Single<T0, T1, T2, T3, T4, T5, T6>(string source, string template,
        int bracketsCount = 1, ParsingOptions? options = null)
        where T0 : IConvertible
        where T1 : IConvertible
        where T2 : IConvertible
    ...
    public static Tuple<T0, T1, T2, T3, T4, T5, T6, T7> Single<T0, T1, T2, T3, T4, T5, T6, T7>(string source,
