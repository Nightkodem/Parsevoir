...
internal class SingleSplitsConverter
{
    ...
    internal Tuple<T0, T1, T2> ToResults<T0, T1, T2>(IReadOnlyList<string> splits)
    {
        T0 val0 = _convert.To<T0>(splits[0]);
        T1 val1 = _convert.To<T1>(splits[1]);
    ...
    internal Tuple<T0, T1, T2, T3> ToResults<T0, T1, T2, T3>(IReadOnlyList<string> splits)
    {
        T0 val0 = _convert.To<T0>(splits[0]);
        T1 val1 = _convert.To<T1>(splits[1]);
        T2 val2 = _convert.To<T2>(splits[2]);
    ...
    internal Tuple<T0, T1, T2, T3, T4> ToResults<T0, T1, T2, T3, T4>(IReadOnlyList<string> splits)
    {
        T0 val0 = _convert.To<T0>(splits[0]);
        T1 val1 = _convert.To<T1>(splits[1]);
        T2 val2 = _convert.To<T2>(splits[2]);
    ...
    internal Tuple<T0, T1, T2, T3, T4, T5> ToResults<T0, T1, T2, T3, T4, T5>(IReadOnlyList<string> splits)
    {
        T0 val0 = _convert.To<T0>(splits[0]);
        T1 val1 = _convert.To<T1>(splits[1]);
        T2 val2 = _convert.To<T2>(splits[2]);
    ...
    internal Tuple<T0, T1, T2, T3, T4, T5, T6> ToResults<T0, T1, T2, T3, T4, T5, T6>(IReadOnlyList<string> splits)
    {
        T0 val0 = _convert.To<T0>(splits[0]);
        T1 val1 = _convert.To<T1>(splits[1]);
        T2 val2 = _convert.To<T2>(splits[2]);
