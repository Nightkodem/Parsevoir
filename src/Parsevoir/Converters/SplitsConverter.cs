...
internal class SplitsConverter
{
    ...
    internal Tuple<T0, T1> ToResults<T0, T1>(IReadOnlyList<SplitResult> splits)
        where T0 : IConvertible
        where T1 : IConvertible
    {
        T0 val0 = Convert.To<T0>(splits[0].Value, _options);
        T1 val1 = Convert.To<T1>(splits[1].Value, _options);
        return new Tuple<T0, T1>(val0, val1);
    }

    internal Tuple<T0, T1, T2> ToResults<T0, T1, T2>(IReadOnlyList<SplitResult> splits)
        where T0 : IConvertible
        where T1 : IConvertible
        where T2 : IConvertible
    {
        ...
        return new Tuple<T0, T1, T2>(val0, val1, val2);
    }

    internal Tuple<T0, T1, T2, T3> ToResults<T0, T1, T2, T3>(IReadOnlyList<SplitResult> splits)
        where T0 : IConvertible
        where T1 : IConvertible
        where T2 : IConvertible
        where T3 : IConvertible
    {
        ...
        return new Tuple<T0, T1, T2, T3>(val0, val1, val2, val3);
    }

    internal Tuple<T0, T1, T2, T3, T4> ToResults<T0, T1, T2, T3, T4>(IReadOnlyList<SplitResult> splits)
        where T0 : IConvertible
        where T1 : IConvertible
        where T2 : IConvertible
        where T3 : IConvertible
        where T4 : IConvertible
    {
        ...
        return new Tuple<T0, T1, T2, T3, T4>(val0, val1, val2, val3, val4);
    }

    internal Tuple<T0, T1, T2, T3, T4, T5> ToResults<T0, T1, T2, T3, T4, T5>(IReadOnlyList<SplitResult> splits)
        where T0 : IConvertible
        where T1 : IConvertible
        where T2 : IConvertible
        where T3 : IConvertible
        ...
        where T5 : IConvertible
    {
        ...
        return new Tuple<T0, T1, T2, T3, T4, T5>(val0, val1, val2, val3, val4, val5);
    }
    
    internal Tuple<T0, T1, T2, T3, T4, T5, T6> ToResults<T0, T1, T2, T3, T4, T5, T6>(IReadOnlyList<SplitResult> splits)
        where T0 : IConvertible
        where T1 : IConvertible
        where T2 : IConvertible
        where T3 : IConvertible
        ...
        where T6 : IConvertible
    {
        ...
        return new Tuple<T0, T1, T2, T3, T4, T5, T6>(val0, val1, val2, val3, val4, val5, val6);
    }
    
    internal Tuple<T0, T1, T2, T3, T4, T5, T6, T7> ToResults<T0, T1, T2, T3, T4, T5, T6, T7>(IReadOnlyList<SplitResult> splits)
        where T0 : IConvertible
        where T1 : IConvertible
        where T2 : IConvertible
        where T3 : IConvertible
        ...
        where T7 : IConvertible
    {
        ...
        return new Tuple<T0, T1, T2, T3, T4, T5, T6, T7>(val0, val1, val2, val3, val4, val5, val6, val7);
    }
